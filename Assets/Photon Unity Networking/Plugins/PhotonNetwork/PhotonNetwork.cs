...
public static class PhotonNetwork
{
	...
	// VIEW & PLAYER LIMIT CAN BE EASILY CHANGED, SEE DOCS
	...
	// in miliseconds. I.e. 100 = 100ms which makes 10 times/second
	...
	// each player only needs to remember it's own (!) last used subId to speed up assignment
	internal static int lastUsedViewSubIdStatic = 0;
	// per room, the master is able to instantiate GOs. the subId for this must be unique too
